...
public class DataLoader implements CommandLineRunner {
    ...
    private void createHarryPotterData(Book book) {
        ...
        Chapter chapter1 = Chapter.builder()
                ...
                .idx(1)
                .title("살아남은 아이")
                .spineHref("Text/chapter_001.xhtml")
                .paragraphCount(1)
                .paragraphStartsJson("[0]")
                .paragraphLengthsJson("[5001]")
                .totalCodePoints(5001)
                .pageStart(1)
                .pageEnd(20)
                .startPos(0)
                .endPos(5000)
        ...
        Chapter chapter2 = Chapter.builder()
                ...
                .idx(2)
                .title("사라진 유리")
                .spineHref("Text/chapter_002.xhtml")
                .paragraphCount(1)
                .paragraphStartsJson("[0]")
                .paragraphLengthsJson("[5000]")
        ...
        Chapter chapter3 = Chapter.builder()
                ...
                .idx(3)
                .title("편지들")
                .spineHref("Text/chapter_003.xhtml")
                .paragraphCount(1)
                .paragraphStartsJson("[0]")
                .paragraphLengthsJson("[5000]")
                .totalCodePoints(5000)
    ...
    private void createLordOfTheRingsData(Book book) {
        ...
        Chapter chapter1 = Chapter.builder()
                ...
                .paragraphCount(1)
                .paragraphStartsJson("[0]")
                .paragraphLengthsJson("[6001]")
                .totalCodePoints(6001)
                .pageStart(1)
                .pageEnd(25)
                .startPos(0)
                .endPos(6000)
        ...
        Chapter chapter2 = Chapter.builder()
                ...
                .paragraphCount(1)
                .paragraphStartsJson("[0]")
                .paragraphLengthsJson("[6000]")
                .totalCodePoints(6000)
                .pageStart(26)
                .pageEnd(50)
                .startPos(6001)
                .endPos(12000)
